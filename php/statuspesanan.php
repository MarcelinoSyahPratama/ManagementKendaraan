...
$list = query("SELECT * FROM pemesanan ORDER BY id desc");
        ...
        <div class="row " id="row">
			...
			<p style="font-size:20px"><center>Selamat Datang admin</center></p>
                ...
                <ul class="nav flex-column text-white">
                    ...
                    <li class="nav-item text-center">
						<a href="statuspesanan.php" class="btn btn-primary mb-3">Data Pesanan</a>
                    </li>
                    <li class="nav-item text-center">
            ...
            <div class="col-md-10 mt-5">
                <div class="card mb-4">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="mb-4 text-start my-3 mx-2 fw-normal">Data Pemesanan Kendaraan</h4>
                        </div>                        
                    </div>
                    
                             
            </div>
            <div class="cetak" style="display:inline-flex;"><a target="_blank" href="export_excel.php?range=bulanan"><button class="btn-info">EXPORT KE EXCEL(Bulanan)</button></a><a target="_blank" href="export_excel.php?range=tahunan"><button class="btn-info">EXPORT KE EXCEL(Tahunan)</button></a></div>
