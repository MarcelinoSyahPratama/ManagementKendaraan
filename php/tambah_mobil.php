...
if(isset($_POST["tambah"]) ) {
    ...
    $date = new DateTime($tglservice);
    $date->add(new DateInterval('P30D'));
    $jadwalService = $date->format('Y-m-d');
    mysqli_query($conn, "INSERT INTO kendaraan VALUES('', '$namaK', '$plat','$bbm','$tglservice','$jadwalService','kosong')");
        ...
        <div class="row " id="row">
            ...
            <div class="col-md-10 mt-5">
                <div class="card mb-4">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="mb-4 text-start my-3 mx-2 fw-normal">Form Tambah Kendaraan</h4>
                        </div>                        
                    </div>
                    <form action="" method="post">
                        <div class="kanan" style="float: right;width:46%;">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="namaKendaraan">
                              </div>
                              <div class="input-group mb-3">
                                <div class="input-group-prepend">
                        ...
                        <div class="kiri" style="float: left;width:50%;">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="bbm">
                              </div>
                              <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                  <span class="input-group-text" id="inputGroup-sizing-default">Tanggal Service</span>
                                </div>
                                <input type="date" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="tglservice">
                              </div>
                        </div>
