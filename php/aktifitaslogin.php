...
$list = query("SELECT * FROM aktifitaslogin ORDER BY id desc");
?>
<!doctype html>
<html lang="en">
        ...
        <div class="row " id="row">
            ...
            <div class="col-md-10 mt-5">
                <div class="card mb-4">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="mb-4 text-start my-3 mx-2 fw-normal">Log Login Pegawai</h4>
                        </div>           
                    </div>
                    <input type="text" class="form-control" onkeyup="caridata()" placeholder="Cari Data Login" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" id="cari">
