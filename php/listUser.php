...
$list = query("SELECT * FROM user ORDER BY id desc");
function hapus($id){
    global $conn;
        ...
        <div class="row " id="row">
            ...
            <div class="col-md-10 mt-5">
                <div class="card mb-4">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="mb-4 text-start my-3 mx-2 fw-normal">List Data User</h4>
                            <a href="tambah_user.php"><button class="btn btn-primary btn-sm">Tambah User</button></a>   
                        </div>           
                    </div>
                    <input type="text" class="form-control" onkeyup="caridata()" placeholder="Cari Data User" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" id="cari">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($list as $row) : ?>
                            <tr>
                                ...
                                <td><a href="deleteUser.php?id=<?php echo $row["id"] ?>"><button class="btn-danger"><i class="fa-solid fa-trash"></i></button></a><a href="edit_user.php?id=<?php echo $row["id"] ?>"><button class="btn-info"><i class="fa-solid fa-pencil"></i></button></a></td>
                            </tr>
                        <?php $i++; ?>
                        <?php endforeach; ?>
