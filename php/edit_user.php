...
if(isset($_POST["edit"]) ) {
    ...
    if($pass==""){
      mysqli_query($conn, "UPDATE  user SET username='$username',nama='$nama',jabatan='$jabatan' where id=$id");
    }else{
      $pass = password_hash($pass, PASSWORD_DEFAULT);
      mysqli_query($conn, "UPDATE  user SET username='$username',pass='$pass',nama='$nama',jabatan='$jabatan' where id=$id");
    }
...
$list = query("SELECT * FROM user WHERE id=$id");
?>
<!doctype html>
<html lang="en">
                    ...
                    <form action="" method="post">
                        <div class="kanan" style="float: right;width:46%;">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="username" value="<?php echo $row["username"]; ?>">
                              </div>
                              <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                  <span class="input-group-text" id="inputGroup-sizing-default">Password</span>
                                </div>
                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="Biarkan kosong jika tidak ingin mengganti" name="pass">
                              </div>
                        </div>
                        <div class="kiri" style="float: left;width:50%;">
                            <div class="input-group mb-3">
                              ...
                              <div class="input-group mb-3">
                                ...
                                <select name="jabatan" id="" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="<?php echo $row["jabatan"]; ?>">
