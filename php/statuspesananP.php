...
$list = query("SELECT * FROM pemesanan WHERE namaAtasan = '$pengawas' ORDER BY id desc");
...
<div class="nav" style="width: 100%;height: 40px;background-color: #000000d7;">
    ...
    <div class="container-fluid">
        <div class="row " id="row">
            ...
            <div class="cetak" style="display:inline-flex;"><a target="_blank" href="export_excelP.php?range=bulanan"><button class="btn-info">EXPORT KE EXCEL(Bulanan)</button></a><a target="_blank" href="export_excelP.php?range=tahunan"><button class="btn-info">EXPORT KE EXCEL(Tahunan)</button></a></div>
